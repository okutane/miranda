 ...
 *
 * (C) 2005-2017 by silvercircle _at_ gmail _dot_ com and contributors
 *
 * $Id$
 *
 */
...
PLUGININFOEX pluginInfo = {
		...
		"Miranda IM", "noreply@miranda-im.org", "Copyright © 2000-2017 Miranda IM Project", "http://www.miranda-im.org",
		UNICODE_AWARE,
		DEFMOD_CLISTALL,
#if defined(_UNICODE)
