...
#define MIRANDA_VERSION_FILEVERSION 0,10,70,0
#define MIRANDA_VERSION_STRING      "0.10.70.0"
#define MIRANDA_VERSION_CORE        MIRANDA_MAKE_VERSION(0, 10, 70, 0)
#define MIRANDA_VERSION_CORE_STRING "0.10.70"
